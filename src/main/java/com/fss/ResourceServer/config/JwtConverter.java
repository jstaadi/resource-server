package com.fss.ResourceServer.config;

import com.fss.ResourceServer.model.AccessTokenMapper;
...
public class JwtConverter extends DefaultAccessTokenConverter implements JwtAccessTokenConverterConfigurer {
    ...
    public OAuth2Authentication extractAuthentication(Map<String, ?> map) {
        ...
        mapper.setId((String) map.get("id"));
        mapper.setUserName((String) map.get("userName"));
        mapper.setName((String) map.get("name"));
